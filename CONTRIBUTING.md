# Redpanda Connect Enterprise Connector Certification

Redpanda Connect supports a wide array of connectors for integrating with popular data systems. While many are community-contributed, Enterprise connectors are officially certified and supported by Redpanda.  
This document outlines the criteria for Enterprise certification, ensuring a great user experience and sustainable supportability, while continuing to welcome high-quality community contributions.

---

## 1. Certification Overview

To certify a connector as Enterprise-grade and supported by Redpanda, it must meet the following requirements:
...
We hold Enterprise-certified connectors to a consistent engineering bar, so they are reliable, maintainable, and supportable.
