...
func TestArgumentTypes(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			err: "bad argument 0: expected number value, found string: nope",
		},
		{
			name: "bad int64",
			args: []interface{}{
			...
			err: "bad argument 1: expected number value, found string: nope",
		},
		{
			name: "bad float64",
			args: []interface{}{
			...
			err: "bad argument 2: expected number value, found string: nope",
		},
		{
			name: "bad bool",
			args: []interface{}{
			...
			err: "bad argument 3: expected bool value, found string: nope",
		},
		{
			name: "bad string",
			args: []interface{}{
			...
			err: "bad argument 4: expected string value, found number: 30",
		},
		{
			name: "good values",
			args: []interface{}{
