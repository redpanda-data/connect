...
import grpc
import grpc.aio
import redpanda.runtime.v1alpha1.processor_pb2
import typing
...
class BatchProcessorServiceStub:
    ...
    Init: grpc.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorInitRequest,
        redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorInitResponse,
    ]
    ...
    ProcessBatch: grpc.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorProcessBatchRequest,
    ...
    Close: grpc.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorCloseRequest,
        redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorCloseResponse,
    ]
...
class BatchProcessorServiceAsyncStub:
    ...
    ProcessBatch: grpc.aio.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorProcessBatchRequest,
        redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorProcessBatchResponse,
    ]
    """Process a batch of messages into one or more resulting batches, or return
...
class BatchProcessorServiceServicer(metaclass=abc.ABCMeta):
    ...
    def Init(
        self,
        request: redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorInitRequest,
        context: _ServicerContext,
    ) -> typing.Union[redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorInitResponse, collections.abc.Awaitable[redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorInitResponse]]:
        """Init is the first method called for a batch processor and it passes the
        user's configuration to the input.
    ...
    def ProcessBatch(
        self,
        request: redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorProcessBatchRequest,
        context: _ServicerContext,
    ) -> typing.Union[redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorProcessBatchResponse, collections.abc.Awaitable[redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorProcessBatchResponse]]:
        """Process a batch of messages into one or more resulting batches, or return
        an error if the entire batch could not be processed. If zero messages are
        returned and the error is nil then all messages are filtered.
    ...
    def Close(
        self,
        request: redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorCloseRequest,
        context: _ServicerContext,
    ) -> typing.Union[redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorCloseResponse, collections.abc.Awaitable[redpanda.runtime.v1alpha1.processor_pb2.BatchProcessorCloseResponse]]:
        """Close the component, blocks until either the underlying resources are
        cleaned up or the RPC deadline is reached.
        """
