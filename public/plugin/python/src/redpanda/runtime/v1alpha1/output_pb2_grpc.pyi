...
import grpc
import grpc.aio
import redpanda.runtime.v1alpha1.output_pb2
import typing
...
class BatchOutputServiceStub:
    ...
    Init: grpc.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.output_pb2.BatchOutputInitRequest,
        redpanda.runtime.v1alpha1.output_pb2.BatchOutputInitResponse,
    ]
    ...
    Connect: grpc.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.output_pb2.BatchOutputConnectRequest,
        redpanda.runtime.v1alpha1.output_pb2.BatchOutputConnectResponse,
    ]
    ...
    Send: grpc.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.output_pb2.BatchOutputSendRequest,
        redpanda.runtime.v1alpha1.output_pb2.BatchOutputSendResponse,
    ]
    ...
    Close: grpc.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.output_pb2.BatchOutputCloseRequest,
        redpanda.runtime.v1alpha1.output_pb2.BatchOutputCloseResponse,
    ]
...
class BatchOutputServiceServicer(metaclass=abc.ABCMeta):
    ...
    def Init(
        self,
        request: redpanda.runtime.v1alpha1.output_pb2.BatchOutputInitRequest,
        context: _ServicerContext,
    ) -> typing.Union[redpanda.runtime.v1alpha1.output_pb2.BatchOutputInitResponse, collections.abc.Awaitable[redpanda.runtime.v1alpha1.output_pb2.BatchOutputInitResponse]]:
        """Init is the first method called for a batch output and it passes the user's
        configuration to the output.
    ...
    def Connect(
        self,
        request: redpanda.runtime.v1alpha1.output_pb2.BatchOutputConnectRequest,
        context: _ServicerContext,
    ) -> typing.Union[redpanda.runtime.v1alpha1.output_pb2.BatchOutputConnectResponse, collections.abc.Awaitable[redpanda.runtime.v1alpha1.output_pb2.BatchOutputConnectResponse]]:
        """Establish a connection to the downstream service. Connect will always be
        called first when a writer is instantiated, and will be continuously
        called with back off until a nil error is returned.
    ...
    def Send(
        self,
        request: redpanda.runtime.v1alpha1.output_pb2.BatchOutputSendRequest,
        context: _ServicerContext,
    ) -> typing.Union[redpanda.runtime.v1alpha1.output_pb2.BatchOutputSendResponse, collections.abc.Awaitable[redpanda.runtime.v1alpha1.output_pb2.BatchOutputSendResponse]]:
        """Write a batch of messages to a sink, or return an error if delivery is
        not possible.
    ...
    def Close(
        self,
        request: redpanda.runtime.v1alpha1.output_pb2.BatchOutputCloseRequest,
        context: _ServicerContext,
    ) -> typing.Union[redpanda.runtime.v1alpha1.output_pb2.BatchOutputCloseResponse, collections.abc.Awaitable[redpanda.runtime.v1alpha1.output_pb2.BatchOutputCloseResponse]]:
        """Close the component, blocks until either the underlying resources are
        cleaned up or the RPC deadline is reached.
        """
