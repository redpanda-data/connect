...
import grpc
import grpc.aio
import redpanda.runtime.v1alpha1.input_pb2
import typing
...
class BatchInputServiceStub:
    ...
    Init: grpc.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.input_pb2.BatchInputInitRequest,
        redpanda.runtime.v1alpha1.input_pb2.BatchInputInitResponse,
    ]
    ...
    Connect: grpc.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.input_pb2.BatchInputConnectRequest,
        redpanda.runtime.v1alpha1.input_pb2.BatchInputConnectResponse,
    ]
    ...
    ReadBatch: grpc.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.input_pb2.BatchInputReadRequest,
        redpanda.runtime.v1alpha1.input_pb2.BatchInputReadResponse,
    ]
    ...
    Ack: grpc.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.input_pb2.BatchInputAckRequest,
        redpanda.runtime.v1alpha1.input_pb2.BatchInputAckResponse,
    ]
    ...
    Close: grpc.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.input_pb2.BatchInputCloseRequest,
        redpanda.runtime.v1alpha1.input_pb2.BatchInputCloseResponse,
    ]
...
class BatchInputServiceAsyncStub:
    ...
    ReadBatch: grpc.aio.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.input_pb2.BatchInputReadRequest,
        redpanda.runtime.v1alpha1.input_pb2.BatchInputReadResponse,
    ]
    """Read a message batch from a source, along with a function to be called
    ...
    Ack: grpc.aio.UnaryUnaryMultiCallable[
        redpanda.runtime.v1alpha1.input_pb2.BatchInputAckRequest,
        redpanda.runtime.v1alpha1.input_pb2.BatchInputAckResponse,
    ]
    """Acknowledge a message batch. This function ensures that the source of the
...
class BatchInputServiceServicer(metaclass=abc.ABCMeta):
    ...
    def Init(
        self,
        request: redpanda.runtime.v1alpha1.input_pb2.BatchInputInitRequest,
        context: _ServicerContext,
    ) -> typing.Union[redpanda.runtime.v1alpha1.input_pb2.BatchInputInitResponse, collections.abc.Awaitable[redpanda.runtime.v1alpha1.input_pb2.BatchInputInitResponse]]:
        """Init is the first method called for a batch input and it passes the user's
        configuration to the input.
    ...
    def Connect(
        self,
        request: redpanda.runtime.v1alpha1.input_pb2.BatchInputConnectRequest,
        context: _ServicerContext,
    ) -> typing.Union[redpanda.runtime.v1alpha1.input_pb2.BatchInputConnectResponse, collections.abc.Awaitable[redpanda.runtime.v1alpha1.input_pb2.BatchInputConnectResponse]]:
        """Establish a connection to the upstream service. Connect will always be
        called first when a reader is instantiated, and will be continuously
        called with back off until a nil error is returned.
    ...
    def ReadBatch(
        self,
        request: redpanda.runtime.v1alpha1.input_pb2.BatchInputReadRequest,
        context: _ServicerContext,
    ) -> typing.Union[redpanda.runtime.v1alpha1.input_pb2.BatchInputReadResponse, collections.abc.Awaitable[redpanda.runtime.v1alpha1.input_pb2.BatchInputReadResponse]]:
        """Read a message batch from a source, along with a function to be called
        once the entire batch can be either acked (successfully sent or
        intentionally filtered) or nacked (failed to be processed or dispatched
        to the output).
    ...
    def Ack(
        self,
        request: redpanda.runtime.v1alpha1.input_pb2.BatchInputAckRequest,
        context: _ServicerContext,
    ) -> typing.Union[redpanda.runtime.v1alpha1.input_pb2.BatchInputAckResponse, collections.abc.Awaitable[redpanda.runtime.v1alpha1.input_pb2.BatchInputAckResponse]]:
        """Acknowledge a message batch. This function ensures that the source of the
        message receives either an acknowledgement (error is missing) or an error
        that can either be propagated upstream as a nack, or trigger a reattempt at
        delivering the same message.
    ...
    def Close(
        self,
        request: redpanda.runtime.v1alpha1.input_pb2.BatchInputCloseRequest,
        context: _ServicerContext,
    ) -> typing.Union[redpanda.runtime.v1alpha1.input_pb2.BatchInputCloseResponse, collections.abc.Awaitable[redpanda.runtime.v1alpha1.input_pb2.BatchInputCloseResponse]]:
        """Close the component, blocks until either the underlying resources are
        cleaned up or the RPC deadline is reached.
        """
