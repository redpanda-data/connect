...
- general: Fixed silent Slack release notification failures by splitting oversized payloads and enabling error reporting. ([@prakhargarg105](https://github.com/prakhargarg105), [#4718](https://github.com/redpanda-data/connect/pull/4718))
