...
`, databaseURL)
	...
	// A re-snapshot, if incorrectly triggered, would add further "read"
	// messages for dbo.events shortly after. Give that a moment, then confirm
	// nothing beyond the two ordinary inserts above ever arrives.
