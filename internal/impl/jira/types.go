...
Changelog will not be exposed as it comes from the API, instead it will be merged into the Fields interface{}
...
All the fields from Fields interface{} will be filtered accordingly using the Fields from JSON input message
*/
...
type ProjectSearchResponse struct {
	Projects []interface{} `json:"values"`
