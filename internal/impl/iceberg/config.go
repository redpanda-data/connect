			...
			service.NewObjectField(ioFieldStorage,
				...
				service.NewObjectField(ioFieldStorageS3,
					...
					service.NewStringField(ioFieldS3Endpoint).
						Description("Custom endpoint for S3-compatible storage (for example, MinIO).").
						Optional().
