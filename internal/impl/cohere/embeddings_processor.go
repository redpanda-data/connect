...
To learn more about vector embeddings, see the https://docs.cohere.com/docs/embeddings[Cohere API documentation^].`).
		...
		Fields(
			...
			service.NewIntField(oepFieldDimensions).
				Optional().
				Description("The number of dimensions (numerical values) in each vector embedding generated by this processor. This parameter only supports https://docs.cohere.com/v2/docs/embeddings[`embed-v4.0`^] and newer models. Possible values are `256`, `512`, `1024`, and `1536`.").
