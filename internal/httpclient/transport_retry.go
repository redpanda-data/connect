...
func newRetryTransport(inner http.RoundTripper, cfg Config, rc *RetryConfig, logger *service.Logger) http.RoundTripper {
	rt := &retryTransport{
		inner:  inner,
		logger: logger,
	}
...
func (t *retryTransport) RoundTrip(req *http.Request) (*http.Response, error) {
	...
	if req.Body != nil && req.GetBody == nil {
		if t.logger != nil {
			t.logger.Warn("HTTP request has body but no GetBody; retries will be skipped")
		}
	}
