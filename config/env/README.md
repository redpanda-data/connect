...
METRICS_INFLUXV1_DB                             = db0
METRICS_INFLUXV1_INCLUDE_DEBUG_GC               = false
METRICS_INFLUXV1_INCLUDE_DEBUG_GC_INTERVAL      = 1m
METRICS_INFLUXV1_INCLUDE_RUNTIME                = false
METRICS_INFLUXV1_INCLUDE_RUNTIME_INTERVAL       = 1m
METRICS_INFLUXV1_INTERVAL                       = 1m
METRICS_INFLUXV1_PASSWORD
METRICS_INFLUXV1_PATH_MAPPING
METRICS_INFLUXV1_PING_INTERVAL                  = 20s
METRICS_INFLUXV1_PRECISION                      = s
METRICS_INFLUXV1_PREFIX                         = benthos.
METRICS_INFLUXV1_RETENTION_POLICY
METRICS_INFLUXV1_TAGS
METRICS_INFLUXV1_TIMEOUT                        = 5s
METRICS_INFLUXV1_URL                            = http://localhost:8086
METRICS_INFLUXV1_USERNAME
METRICS_INFLUXV1_WRITE_CONSISTENCY
