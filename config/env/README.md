...
METRICS_INFLUX_DB                               = db0
METRICS_INFLUX_INCLUDE_DEBUG_GC
METRICS_INFLUX_INCLUDE_RUNTIME
METRICS_INFLUX_INTERVAL                         = 1m
METRICS_INFLUX_PASSWORD
METRICS_INFLUX_PATH_MAPPING
METRICS_INFLUX_PING_INTERVAL                    = 20s
METRICS_INFLUX_PRECISION                        = s
METRICS_INFLUX_PREFIX                           = benthos.
METRICS_INFLUX_RETENTION_POLICY
METRICS_INFLUX_TAGS
METRICS_INFLUX_TIMEOUT                          = 5s
METRICS_INFLUX_URL                              = http://localhost:8086
METRICS_INFLUX_USERNAME
METRICS_INFLUX_WRITE_CONSISTENCY
