...
```
BUFFER_TYPE                                                   = none
BUFFER_BOLT_BATCH_POLICY_BYTE_SIZE                            = 0
BUFFER_BOLT_BATCH_POLICY_CONDITION_BOUNDS_CHECK_MAX_PARTS     = 100
BUFFER_BOLT_BATCH_POLICY_CONDITION_BOUNDS_CHECK_MAX_PART_SIZE = 1073741824
BUFFER_BOLT_BATCH_POLICY_CONDITION_BOUNDS_CHECK_MIN_PARTS     = 1
BUFFER_BOLT_BATCH_POLICY_CONDITION_BOUNDS_CHECK_MIN_PART_SIZE = 1
BUFFER_BOLT_BATCH_POLICY_CONDITION_CHECK_INTERPOLATION_VALUE
BUFFER_BOLT_BATCH_POLICY_CONDITION_COUNT_ARG                  = 100
BUFFER_BOLT_BATCH_POLICY_CONDITION_JMESPATH_PART              = 0
BUFFER_BOLT_BATCH_POLICY_CONDITION_JMESPATH_QUERY
BUFFER_BOLT_BATCH_POLICY_CONDITION_METADATA_ARG
BUFFER_BOLT_BATCH_POLICY_CONDITION_METADATA_KEY
BUFFER_BOLT_BATCH_POLICY_CONDITION_METADATA_OPERATOR          = equals_cs
BUFFER_BOLT_BATCH_POLICY_CONDITION_METADATA_PART              = 0
BUFFER_BOLT_BATCH_POLICY_CONDITION_NUMBER_ARG                 = 0
BUFFER_BOLT_BATCH_POLICY_CONDITION_NUMBER_OPERATOR            = equals
BUFFER_BOLT_BATCH_POLICY_CONDITION_NUMBER_PART                = 0
BUFFER_BOLT_BATCH_POLICY_CONDITION_PROCESSOR_FAILED_PART      = 0
BUFFER_BOLT_BATCH_POLICY_CONDITION_RESOURCE
BUFFER_BOLT_BATCH_POLICY_CONDITION_STATIC                     = false
BUFFER_BOLT_BATCH_POLICY_CONDITION_TEXT_ARG
BUFFER_BOLT_BATCH_POLICY_CONDITION_TEXT_OPERATOR              = equals_cs
BUFFER_BOLT_BATCH_POLICY_CONDITION_TEXT_PART                  = 0
BUFFER_BOLT_BATCH_POLICY_CONDITION_TYPE                       = static
BUFFER_BOLT_BATCH_POLICY_COUNT                                = 0
BUFFER_BOLT_BATCH_POLICY_ENABLED                              = false
BUFFER_BOLT_BATCH_POLICY_PERIOD
BUFFER_BOLT_FILE
BUFFER_BOLT_PREFETCH_COUNT                                    = 50
