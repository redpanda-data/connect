...
INPUT_BLOB_STORAGE_CODEC                             = all-bytes
INPUT_BLOB_STORAGE_CONTAINER
INPUT_BLOB_STORAGE_DELETE_OBJECTS                    = false
INPUT_BLOB_STORAGE_PREFIX
INPUT_BLOB_STORAGE_STORAGE_ACCESS_KEY
INPUT_BLOB_STORAGE_STORAGE_ACCOUNT
INPUT_BLOB_STORAGE_STORAGE_CONNECTION_STRING
INPUT_BLOB_STORAGE_TIMEOUT                           = 0s
