...
# Example: ./format-component-fields.sh input kafka_franz

set -euo pipefail

CATEGORY="$1"  # e.g., "input", "output", "processor"
...
rpk connect list --format jsonschema "${CATEGORY}s" | python3 "$SCRIPT_DIR/format-component-fields.py" "$COMPONENT"
