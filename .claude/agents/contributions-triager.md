...
tools: bash, file_access, git, gh
allowed-tools: Bash(gh pr list:*), Bash(gh issue list:*), Bash(gh pr view:*), Bash(gh issue view:*), Bash(gh search issues:*), Bash(gh search prs:*), Bash(git log:*), Bash(git show:*), Bash(git diff:*)
model: sonnet
memory: project
---
